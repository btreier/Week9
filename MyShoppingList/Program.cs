...
namespace MyShoppingList
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string rootDirectory = @"C:\Users\...\Desktop\Programmeerimine";
            ...
            {
                Console.WriteLine($"My shopping list: {item}");
            }
            bool loopActive = true;

            while (loopActive)
            {
                Console.WriteLine("Would you like to add something else to your shopping list? Y/N:");
